...
namespace COSUMIR_API_TEST.Servicios
{
    public class Servicio_API : IServicio_API
    {
        ...
        public Servicio_API()
        {
            ...
            // Validar que _baseUrl no esté vacío y tenga un formato correcto
            if (string.IsNullOrEmpty(_baseUrl))
            {
                throw new ArgumentException("El valor de 'baseUrl' no puede estar vacío");
            }
            ...
            {
                throw new ArgumentException("El URI base proporcionado no es válido", ex);
            }
        }
